...
This is the ground-truth source the Reasoning Gate checks the final mandate
against. In a real AP2-style system this would be the merchant's signed
product/cart data; here it's a simple in-memory table standing in for that
trust boundary.
"""
...
CATALOG = {
    "SKU_HP_001": {
        ...
        "price": 129.99,
        # Untrusted free-text field, as it would arrive from a scraped/rendered
        # listing page -- this is the injection surface.
        "description_clean": (
    ...
    "SKU_WATCH_002": {
        ...
        "price": 89.50,
        "description_clean": (
            "Fitness tracking smartwatch with heart-rate monitor and "
            "7-day battery."
        ),
        "description_injected": (
